import type { HassEntities, HassEntity, HassEntityAttributeBase, HassEntityBase } from "home-assistant-js-websocket";
...
export const filterUpdateEntities = (entities: HassEntities, language?: string) =>
  (Object.values(entities).filter((stateObj) => computeStateDomain(stateObj) === "update") as UpdateEntity[]).sort(
    (a, b) => {
